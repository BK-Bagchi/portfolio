            ...
            <div className="row w-100">
                ...
                <div className="col-md-9">
                    ...
                    <div className="objective my-5">
                        ...
                        <p class="m-0">Love to work with web technologies and make different UI. The initial goal is to
                    ...
                    <div className="experience my-5">
                        <h3>Experience</h3>
                        <p class="m-0" className="text-muted m-0">Oct 2020- Present</p>
                        <h5>Software Developer (Intern)</h5>
                        <h4 className="text-dark d-inline">Pipesort Technologies LLP,</h4> <p class="m-0" className="text-muted d-inline">Chennai, India</p>
                    </div>
